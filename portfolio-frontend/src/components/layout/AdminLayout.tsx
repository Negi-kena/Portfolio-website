  ...
  return (
    <div className="min-h-screen bg-navy-950 text-paper">
      ...
      <div className="flex min-h-screen">
        ...
        {/* Mobile navigation */}
        {mobileOpen && (
          <div id="admin-mobile-nav" className="fixed inset-x-0 top-[65px] z-30 border-b border-navy-700 bg-navy-950 p-4 shadow-2xl md:hidden">
        ...
        <div className="min-w-0 flex-1">
          <main className="mx-auto max-w-6xl px-5 py-7 sm:px-7 md:px-10 md:py-10">
            <ErrorBoundary label="This admin screen">
              <Outlet />
            </ErrorBoundary>
          </main>
        </div>
